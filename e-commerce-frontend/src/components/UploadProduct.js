...
//         setItemImage((prev) => {
//             return [...prev, uploadImageCloudinary]
//         })
//         
...
//         // 
//         const newProductImage = [...DisplayImage]
//         
//         newProductImage.splice(index, 1)

//         setItemImage((prev) => {
//             return [...prev, ...newProductImage]
//         })
...
//                                 <input className="p-2 rounded-xl border w-full" type="text" name="productName" id="productName" placeholder="Enter Product Name" {...register("Product Name", { required: true })} onChange={handleChange} />
//                                 <label className='mt-8' htmlFor='brandName'>Brand Name:</label>
//                                 <input className="p-2 rounded-xl border w-full" type="text" name="brandName" id="brandName" placeholder="Enter Brand Name" {...register("Brand Name", { required: true })} onChange={handleChange} />
...
//                                             return (
//                                                 <option className='flex' value={el.value} key={el.value + index} onChange={handleChange}>{el.label}</option>
//                                             )
//                                         })
//                                     }
//                                 </select>
...
//                                             <input className="hidden" type="file" name="productImage" id="productImageInput" placeholder="Enter Product Image" {...register("Product Image", { required: true })} onChange={handleUploadProduct} />
//                                         </div>
//                                     </div>
//                                 </label>
//                                 <div className='mt-3'>
...
//                                                         <img src={element.url} alt={element} className='w-20 h-20 rounded-lg' onClick={() => {
//                                                             setOpenFullScreenImage(true)
//                                                             setFullScreenImage(element.url)
//                                                         }} />
//                                                         <div className='text-[rgb(239,224,226)] text-xl absolute top-0 right-0 cursor-pointer' onClick={()=>handleDeleteProductImage(index)}>
//                                                             <IoCloseCircle />
//                                                         </div>
//                                                     </div>
//                                                 )
...
//                                 <input className="p-2 rounded-xl border w-full" type="textarea" name="description" id="description" placeholder="Enter Description" {...register("description", { required: true })} />
...
//                                 <label className='mt-8' htmlFor='price'>Selling</label>
//                                 <input className="p-2 rounded-xl border w-full" type="number" name="price" id="price" placeholder="Enter Price" {...register("price", { required: true })} />
//                             </div>
//                         </Form>
//                     </div>
                ...
                <div className="mt-4">
                    <div className="grid gap-6">
                        <Form onSubmit={handleSubmit(onFormSubmit)}>
                            ...
                            <label className='mt-8' htmlFor='selling'>Selling</label>
                            <input className="p-2 rounded-xl border w-full" type="number" name="selling" id="selling" placeholder="Enter Selling Price" {...register("selling", { required: true })} onChange={handleUploadProduct} />
                            <label className='mt-12' htmlFor='description'>Description</label>
